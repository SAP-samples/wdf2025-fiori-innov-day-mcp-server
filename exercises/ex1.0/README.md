...
4. Cline prepares an **Implementation Plan** using the AI model and MCP servers.
...
7. **Cline may request** approval to use MCP servers. Click **Approve**.

8. After completing all the planned steps, the application should automatically open in your browser, displaying a travel list report application that matches the list report Image.
